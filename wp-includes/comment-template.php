...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields = array(
		'author' => sprintf(
			...
			sprintf(
				'<input id="author" class="input-text" name="author" type="text" value="%s" size="30" maxlength="245"%s  placeholder="Name"/>',
		...
		'email'  => sprintf(
			...
			sprintf(
				'<input id="email" class="input-text" name="email" %s value="%s" size="30" maxlength="100" aria-describedby="email-notes"%s placeholder="Email"/>',
	...
	$defaults = array(
		...
		'comment_field'        => sprintf(
			...
			'<textarea id="comment" class="txta" name="comment"  required="required" placeholder="Comment"></textarea>'
		),
		'must_log_in'          => sprintf(
