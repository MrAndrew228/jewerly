...
/*	wp_enqueue_script('jewerly-navigation', get_template_directory_uri() . '/media/js/navigation.js', array(), _S_VERSION, true);
	wp_enqueue_script('jewerly-textarea_auto-resize', get_template_directory_uri() . '/media/js/textarea_auto-resize.js', array(), _S_VERSION, true);
	wp_enqueue_script('jewerly-main', get_template_directory_uri() . '/media/js/main.js', array(), _S_VERSION, true);*/
	wp_enqueue_script('jewerly-all', get_template_directory_uri() . '/build/js/all.js', array(), _S_VERSION, true);
